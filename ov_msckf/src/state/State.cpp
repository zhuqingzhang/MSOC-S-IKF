...
State::State(StateOptions &options): kfdatabase(new KeyframeDatabase()) {

    // Save our options
    _options = options;

    transform_vio_to_map=new PoseJPL();
    ...
    _Cross_Cov_AN = 1e-3*Eigen::MatrixXd::Identity(current_id, 0);
