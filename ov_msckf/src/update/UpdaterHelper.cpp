...
void UpdaterHelper::get_feature_jacobian_kf3(State *state, UpdaterHelperFeature &feature, Eigen::MatrixXd &H_f,
                                            Eigen::MatrixXd &H_n,Eigen::MatrixXd &H_x, Eigen::VectorXd &res, std::vector<Type *> &n_order,
                                            std::vector<Type *> &x_order) {
    // Total number of measurements for this feature
    int total_meas = 0;
...
//void UpdaterHelper::get_feature_jacobian_kf5(State *state, UpdaterHelperFeature &feature, Eigen::MatrixXd &H_f,
//                                            Eigen::MatrixXd &H_n,Eigen::MatrixXd &H_x, Eigen::VectorXd &res, std::vector<Type *> &n_order,
//                                            std::vector<Type *> &x_order) {
//    // Total number of measurements for this feature
//    int total_meas = 0;
