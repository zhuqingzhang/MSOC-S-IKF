...
//          Handle IMU measurement
        ...
        if (s2 != nullptr && m.getTopic() == topic_imu) {
            ...
            Eigen::Matrix<double,3,4> w_r,a_r;
//            w_r<<9.9567949771881104e-01, 0., 0., 1.9203490810468793e-03, 0.,
//                    9.9803745746612549e-01, 0., 2.1561817266047001e-03, 0., 0.,
//                    9.9269545078277588e-01, 1.1997447581961751e-03;
//            a_r<<1.0138926506042480e+00, 0., 0., -5.1095332950353622e-02,
//                    0., 1.0174480676651001e+00, 0., 2.7321520447731018e-01, 0., 0.,
//                    1.0285693407058716e+00, 9.4960018992424011e-02;
//            Eigen::Matrix<double ,3,1> w,a;
//            w=w_r*wm;
//            a=a_r*am;
