...
int main(int argc, char** argv)
{
    ...
    string map_cam_pose_file=params.map_save_path+"MH_01_easy_cam.txt";
    string map_cam_pose_file_turb=params.map_save_path+"MH_01_easy_turb_cam_ind_0.01_0.00025.txt";
...
//                            cout<<"get kf pose"<<endl;
                    ...
                    {
                        // kfs_ts_with_gt.push_back(matching_kfs_ts[i]);  //for YQ
