 ...
 */
#ifndef OV_RIMSCKF_VIOMANAGER_H
#define OV_RIMSCKF_VIOMANAGER_H
...
namespace ov_rimsckf {
    ...
    public:
         ...
         */
        VioManager(VioManagerOptions& params_, Simulator* sim_=nullptr);
        ...
        {
           double ts1=((timestamp*100)-5)/100.0;  //minus 0.03s
            double ts2=((timestamp*100)+5)/100.0;  //add 0.03s
            vector<double> ts;
