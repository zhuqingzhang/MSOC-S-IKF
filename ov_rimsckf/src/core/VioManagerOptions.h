 ...
 */
#ifndef OV_RIMSCKF_VIOMANAGEROPTIONS_H
#define OV_RIMSCKF_VIOMANAGEROPTIONS_H
...
namespace ov_rimsckf {
    ...
    struct VioManagerOptions {
        ...
        MatchBaseOptions match_base_options;
        ...
        ///added by zzq
        std::string map_save_path ="/home/zzq/Code/map_open_vins_ros/src/open_vins/map/";

        std::string pose_graph_filename="pose_graph.txt";

        std::string keyframe_pose_filename="gt_cam.txt";

        std::string points_filename="match_points.txt";

        std::string transform_filename="match_points.txt";

        // std::string voc_filename="brief_k10L6.bin";

        // std::string brief_pattern_filename="brief_patten.yml";

        // std::string map_feature_type = "brief";

        int match_num_thred=15;

        double pixel_error=3;

        double kf_match_interval=1;

        bool use_robust_match=false;
        ...
        string sim_traj_path_turb = "../ov_data/sim/udel_gore.txt";
