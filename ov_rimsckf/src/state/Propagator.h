 ...
 */
#ifndef OV_RIMSCKF_STATE_PROPAGATOR_H
#define OV_RIMSCKF_STATE_PROPAGATOR_H
...
namespace ov_rimsckf {
    ...
    public:
         ...
         */
        //TODO: this function doesn't handle the covariance, just state.
    ...
    protected:
        ...
        void predictNewState(State *state, double dt,
            const Eigen::Vector3d &w_hat1, const Eigen::Vector3d &a_hat1,
            const Eigen::Vector3d &w_hat2, const Eigen::Vector3d &a_hat2,
            Eigen::Vector4d &new_q, Eigen::Vector3d &new_v, Eigen::Vector3d &new_p);
...
#endif //OV_RIMSCKF_STATE_PROPAGATOR_H
