...
#ifndef OV_RIMSCKF_PARSE_ROSHANDLER_H
#define OV_RIMSCKF_PARSE_ROSHANDLER_H
...
namespace ov_rimsckf {
    ...
    VioManagerOptions parse_ros_nodehandler(ros::NodeHandle &nh) {
        ...
        // nh.param<std::string>("brief_pattern_filename",params.brief_pattern_filename,params.brief_pattern_filename);
        // nh.param<std::string>("voc_filename",params.voc_filename,params.voc_filename);
        ...
        //params for matching with map online
        ...
        nh.param<double>("keyframe_cov_pos",params.state_options.keyframe_cov_pos,params.state_options.keyframe_cov_pos);
        nh.param<double>("keyframe_cov_ori",params.state_options.keyframe_cov_ori,params.state_options.keyframe_cov_ori);
        ...
        nh.param<bool>("av_has_noise", params.state_options.av_has_noise, params.state_options.av_has_noise);
        ...
        // nh.param<int>("up_global_chi2_multipler", params.msckf_options.chi2_multipler_global, params.msckf_options.chi2_multipler_global);
