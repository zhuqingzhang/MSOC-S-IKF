...
namespace ov_eval {
    ...
    public:
        ...
        void calculate_rpe_2d(const std::vector<double> &segment_lengths, std::map<double,std::pair<Statistics,Statistics>> &error_rpe);
        ...
        void calculate_inv_nees(Statistics &nees_ori, Statistics &nees_pos);

        void calculate_invariant_nees(Statistics &nees_ori, Statistics &nees_pos);

        void calculate_invariant_transform_nees(std::vector<Eigen::Matrix<double,7,1>>& est_traj_poses,std::vector<Eigen::Matrix<double,7,1>>& gt_traj_poses,
        ...
        void calculate_invariant_error(Statistics &posx, Statistics &posy, Statistics &posz,
                             Statistics &orix, Statistics &oriy, Statistics &oriz,
                             Statistics &roll, Statistics &pitch, Statistics &yaw);

        void calculate_invariant_transform_error(std::vector<Eigen::Matrix<double,7,1>>& est_traj_poses,std::vector<Eigen::Matrix<double,7,1>>& gt_traj_poses,
