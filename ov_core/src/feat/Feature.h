...
namespace ov_core {
    ...
    public:
        ...
        ///map of timestamp the matched occured  and the match information :map between keyframe timestamp (these keyframe are from keyframeDatabase) and the point_id(local id) in the keyframe
        ...
        bool new_extracted_map_match=false; //used to denote whether this feature is new extracted for map use.
