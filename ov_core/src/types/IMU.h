    ...
    public:
        ...
        */
        ...
        void set_linp(const Eigen::MatrixXd new_value) override {
            ...
            _pose->set_linp(new_value.block(0, 0, 7, 1));
            _v->set_linp(new_value.block(7, 0, 3, 1));
            _bg->set_linp(new_value.block(10, 0, 3, 1));
            _ba->set_linp(new_value.block(13, 0, 3, 1));
        ...
        Eigen::Matrix<double, 4, 1> quat_linp() const {
            return _pose->quat_linp();
        }
        ...
        Eigen::Matrix<double, 3, 1> pos_linp() const {
            return _pose->pos_linp();
        }
        ...
        // FEJ velocity access
        Eigen::Matrix<double, 3, 1> vel_linp() const {
            return _v->linp();
        }
        ...
        Eigen::Matrix<double, 3, 1> bias_g_linp() const {
            return _bg->linp();
        }
        ...
        Eigen::Matrix<double, 3, 1> bias_a_linp() const {
            return _ba->linp();
        }
